local frame = Def.ActorFrame
{
	...
	LoadFont("Common", "normal") .. {
		OnCommand=cmd(halign,0;x,-80;y,-130;zoom,0.65;playcommand,"CurrentCourseChanged");
	...
	LoadFont("Common", "normal") .. {
		OnCommand=cmd(halign,0;x,-80;y,-100;zoom,0.65;playcommand,"CurrentTrailP1Changed");
